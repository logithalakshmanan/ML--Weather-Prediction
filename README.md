...
The objective of this experiment is to develop a machine learning model using the Random Forest Algorithm to predict daily temperature, PM2.5 pollution levels, and solar radiation based on environmental sensor data. Accurate prediction of these parameters helps in weather monitoring and environmental analysis.

The dataset used contains time-series weather data collected from sensors, including attributes such as temperature, humidity, pressure, wind speed, illumination, CO2 levels, PM2.5, and solar radiation. The data is preprocessed to handle missing values and arranged in chronological order for effective model training and prediction.
...
## Algorithm
1.1. Load and preprocess the weather data by handling missing values and sorting by time.
2. Create features using time encoding (sin/cos) and lag values to capture patterns.
3. Train a Random Forest Regressor on 80% data and test on remaining 20%.
4. Evaluate performance and predict future temperature, pollution, and solar radiation values. 
...
## Output:
<img width="1249" height="582" alt="image" src="https://github.com/user-attachments/assets/13d326d8-dd1c-414c-9167-e882baccde01" />
<img width="1235" height="457" alt="image" src="https://github.com/user-attachments/assets/f6d9b6b5-9d47-4e54-88e7-f43823c0cdca" />
<img width="1255" height="590" alt="image" src="https://github.com/user-attachments/assets/6cd8a622-22fc-4785-b7b1-3c8558a0f33f" />

## Result:
Random Forest Algorithm for Weather Prediction is successfully implemented.
